...
@NoArgsConstructor
@Builder
@Entity(name = "RandomAccessMemoryType")
@Table(name = "random_access_memory_type",
        uniqueConstraints = {
                @UniqueConstraint(name = "random_access_memory_type_name_unique", columnNames = "name")
        }
)
public class RandomAccessMemoryType{
    @Id
    @SequenceGenerator(
