    ...
    let cases = [
        {
            ...
            "numberOfHDD": 3,
            "numberOfSSD": 2,
            "imageUrl":"https://brightxchangeprojectbucket.s3.eu-central-1.amazonaws.com/product_26.jpg"
        },{
            "price": 233.9,
            "currency":{
                "currency":"RON"
                    ...
                    {cases.map((e,i) =>
                        ...
                        <div key={"case_"+i} className="custom-card">
                            ...
                            <div className="custom-card-header">
                                <p className="custom-card-title">Carcasa {e.caseProducer.name} {e.caseType.name} {e.model}</p>
                            </div>
                            ...
                            <div className="custom-card-body">
                                <div className="custom-card-text">
                                    <p className="lead">{e.price} {e.currency.currency}</p>
                                </div>
                                <div className="custom-card-text">
                                    <button className="btn btn-success add-product">Adauga in cos
                                    </button>
                                </div>
                            </div>
                        </div>
